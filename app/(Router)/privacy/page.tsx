...
export default function page() {
    ...
    return (
        <div className=" p-2">
            ...
            <h1 className=" text-2xl">隐私策略</h1>
            <h2 className=" text-xl mt-3">1. 概述</h2>
            访问本网站，您不仅同意本隐私政策，还同意我们的使用条款和使用本网站的任何其他书面协议。并且您同意我们收集和使用任何个人数据（如此处所述）以及公开/无需许可的区块链技术的功能。
            
            本隐私政策（以下简称“隐私政策”）全面描述了 Tape（以下简称“我们”或“我们的”）如何收集、使用和共享与网站 coinipfs.com 相关的信息，以及您对此类信息的权利和选择。
            ...
            <h2 className=" text-xl mt-3">2. 信息收集</h2>
            ...
            <h2 className=" text-xl mt-3">3. 信息的使用</h2>
            我们可能需要使用它来运营和管理本网站（或其他地方）上的服务，为您提供支持，确保我们遵守法律法规，以及执行本网站的安全性或进行其他改进。
            
            <h2 className=" text-xl mt-3">4. 第三方</h2>
            本隐私政策不适用于我们不拥有或控制的网站、应用程序、产品或服务。例如，您与以太坊钱包的交互受该特定钱包的适用隐私政策的约束。
            
            <h2 className=" text-xl mt-3">5. 分析</h2>
            我们使用 Metabase 和 Clickhouse 的内部自托管实例进行事件收集和分析，以改进网站。
            ...
            您的数据永远不会离开我们的受控环境。
            我们不会与第三方分析提供商共享这些数据。
            <h2 className=" text-xl mt-3">6. 您的权利和选择</h2>
            饼干。我们只使用绝对必要的 cookie。这些 Cookie 对于您浏览网站和使用其功能（包括访问网站的安全区域）至关重要。
            请勿跟踪。您的浏览器设置可能允许您自动将“请勿跟踪”信号传输到您访问的在线服务。但请注意，对于网站和应用程序运营商应该如何应对这些信号，行业还没有达成共识。因此，除非法律被解释为要求我们这样做，否则我们不会监控“请勿跟踪”信号或对其采取行动。有关“请勿跟踪”的更多信息，请访问 <a href="https://allaboutdnt.com" className=" link  link-success" target='_blank'>https://allaboutdnt.com</a>
            <h2 className=" text-xl mt-3">7. 数据安全</h2>
            我们实施并维护合理的管理、物理和技术安全保护措施，以帮助保护有关您的信息免遭丢失、被盗、滥用、未经授权的访问、披露、更改和销毁。然而，通过互联网传输并不完全安全，我们无法保证有关您的信息的安全性。
            
            <h2 className=" text-xl mt-3">8. 儿童</h2>
            本网站面向普通受众，不针对儿童。要使用本网站，您必须在法律上能够签订本协议。我们不会故意收集儿童的个人信息。
            
            <h2 className=" text-xl mt-3">9. 政策变更</h2>
            我们保留随时修订和重新发布本隐私政策的权利。任何更改将在我们发布修订后的隐私政策后立即生效。为避免疑义，您继续使用本网站即表示您同意当时发布的修订后的隐私政策。
            
            <h2 className=" text-xl mt-3">10. 联系我们</h2>
            如果您对本隐私政策、我们的数据实践或我们对适用法律的遵守情况有任何疑问或意见，请通过 cs@callha.com 与我们联系。
        </div>
    )
}