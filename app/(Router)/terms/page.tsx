...
export default function page() {
    return (
        <div className=" p-2">
            <h1 className=" text-2xl">条款与细则</h1>
            ...
            <h2 className=" text-xl mt-3">4. 用户内容</h2>
            ...
            <h2 className=" text-xl mt-3">5. 知识产权和所有权</h2>
            ...
            <h2 className=" text-xl mt-3">9. 个人信息</h2>
            您通过本网站提交的个人信息受我们的隐私政策的约束。

            <h2 className=" text-xl mt-3">10. 禁止使用</h2>
