...
export default function Page() {
  ...
  const faqItems = [
    {
      question: "什么是Hayi?",
      answer: "HaYi 是一个基于lens协议和区块链技术构建的去中心化社交媒体平台。它允许用户连接、共享内容和交互，同时保持对其数据和数字身份的控制。"
    },
    {
      question: "HaYi 与传统社交媒体有何不同？",
      answer: "HaYi 利用区块链技术为用户提供数据所有权、增强的隐私以及直接通过其内容获利的能力。与传统平台不同，HaYi 不依赖中央机构来管理用户数据和交互。"
    },
    {
      question: "怎么才能使用 HaYi 吗？",
      answer: "HaYi基于Lens协议开发，您的EVM钱包需要拥有lens账户NFT登入。"
    },
    {
      question: "HaYi 如何确保用户隐私？",
      answer: "HaYi 使用去中心化身份解决方案和端到端加密进行消息传递。您的数据存储在分布式网络而不是集中式服务器上，因此您可以更好地控制自己的信息。"
    },
    {
      question: "我可以在 HaYi 上赚钱吗？",
      answer: "是的，HaYi 为用户提供了各种机会，让他们通过他们的内容和互动获利。这可能包括出售 NFT、接收加密货币小费或参与基于代币的治理系统。"
    }
  ]
