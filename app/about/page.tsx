    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#C0E218] py-20">
        <div className=" mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">欢迎来到 HaYi</h2>
      ...
      <section className="py-20">
        <div className=" mx-auto px-4">
          <h3 className="text-3xl font-bold text-center text-gray-800 mb-12">为什么选择 Hayi？</h3>
      ...
      <p className="text-xl bg-zinc-700 py-5 text-center text-slate-200"> © 2024 coinipfs.com All Rights Reserved.</p>
    </div>
  )
}