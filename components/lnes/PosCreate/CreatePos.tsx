...
export default function CreatePos() {
    ...
    return (
        <>
            <div data-dial-init className="fixed bottom-16 end-2 group">
{/*                 <div id="speed-dial-menu-text-outside-button-square" className="flex flex-col items-center  mb-4 space-y-2">
                ...
                <button type="button" data-dial-toggle="speed-dial-menu-text-outside-button-square" aria-controls="speed-dial-menu-text-outside-button-square" aria-expanded="false" className="flex items-center justify-center text-black bg-primary rounded-full w-14 h-14 hover:bg-primary ">
